...
export const EXPERIENCES = [
  {
    ...
    company: "Byteridge",
    description: `Working on modernizing internal web portals and building modular UI flows. Improved dashboard rendering speed and implemented reusable component patterns for long-term maintainability.`,
    technologies: ["React.js", "UI Architecture", "Performance Optimization"],
  },
  {
    year: "Apr 2025 - Aug 2025",
    role: "Frontend Developer (Freelance)",
    company: "CodeAnt AI",
    description: `Developed UI for AI-driven code analysis features. Built interactive components, integrated REST APIs, and improved the UX for repository insights and onboarding flows.`,
    technologies: ["React.js", "REST APIs", "UX Enhancements"],
  },
  {
    year: "Oct 2023 - Jun 2025",
    role: "Frontend Developer (Full-time)",
    company: "Refyne India",
    description: `Implemented core UI for earned-wage access dashboards. Improved state management, built secure authentication flows, and collaborated with backend teams to optimize API-based data rendering.`,
    technologies: ["React.js", "State Management", "Secure Flows"],
  },
  {
    year: "Mar 2025 - Apr 2025",
    role: "Frontend Developer (Freelance)",
    company: "Studio7",
    description: `Delivered a lightweight internal dashboard with clean layouts and reusable components. Improved mobile responsiveness and optimized component rendering.`,
    technologies: ["React.js", "Responsive Design", "Component Reusability"],
  },
  {
    year: "Feb 2025 - Apr 2025",
    role: "Frontend Web Developer (Freelance)",
    company: "Stoa School",
    description: `Built subscription pages, improved payment flow UI, and created reusable form components. Enhanced overall user navigation and reduced frontend bottlenecks.`,
    technologies: ["React.js", "Payments UI", "UX Improvements"],
  },
  {
    year: "Jul 2022 - Sep 2023",
    role: "Frontend Developer (Full-time)",
    company: "Wipro",
    description: `Worked on enterprise-grade dashboards, improved cross-browser compatibility, and implemented large-scale UI components for internal tools and client projects.`,
    technologies: ["React.js", "Enterprise UI", "Cross-Browser Support"],
  },
];
